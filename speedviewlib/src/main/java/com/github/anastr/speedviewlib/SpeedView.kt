...
//
        ...
        sections.forEach {
            ...
            if (it.style == Section.Style.ROUND) {
                ...
                val roundAngle = (it.width * .5f * 180 / (speedometerRect.width()  * Math.PI)).toFloat()
                speedometerPaint.strokeCap = Paint.Cap.ROUND
                c.drawArc(speedometerRect, startAngle + roundAngle, sweepAngle - roundAngle * 100f, false, speedometerPaint)
            }
            else {
